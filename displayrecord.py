...
class Display :
    def __init__(self, root, msg):
        ...
        self.e2 = Entry(self.root, textvariable=self.entryTextE2, state='disabled', width=20,
                        font="Times 25")
        ...
        self.e3 = Entry(self.root, textvariable=self.entryTextE3, state='disabled', width=20,
                        font="Times 25")
        
        self.b1 = Button(self.root, text="Exit",
                             width=20, height=2,
                             bg='light blue',
                             command=self.exitWindow)
        
        self.b2 = Button(self.root, text="Back",
                             width=20, height=2,
                             bg='light blue',
